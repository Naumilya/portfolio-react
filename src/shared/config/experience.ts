...
export const experience: ExperienceItem[] = [
  {
    ...
    context:
      "B2B/CRM-, HR- и административные интерфейсы в составе крупного продукта.",
    responsibilities: [
      ...
      "Интегрировал клиентские интерфейсы с REST API и BFF",
    ...
    result:
      "Поддерживал и развивал существующий продукт, внедрял новые фичи и участвовал в улучшении кода.",
    stack: [
      "React",
      "TypeScript",
      "Redux Toolkit",
  ...
  },
  {
    ...
    result:
      "Разрабатывал и сопровождал коммерческий сайт до и после релиза.",
